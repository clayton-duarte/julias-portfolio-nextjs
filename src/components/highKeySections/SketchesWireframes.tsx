  ...
  return (
    <>
      <Grid container p="0 3rem">
        ...
        <Image src={sketches} alt="high-key-app" priority />
        <Grid gap="3rem" m="5rem 0" xs="minmax(auto, 540px)">
        ...
        <Image src={wireframes} alt="high-key-app" priority />
      </Grid>
      <Grid bg="PRIMARY" color="WHITE" m="3rem 0">
      ...
      <Grid container p="0 3rem">
        ...
        <Image src={onboarding} alt="high-key-app" priority />
        ...
        <Image src={midFiToEnding} alt="high-key-app" priority />
        ...
        <Image src={consistentDescribe} alt="high-key-app" priority />
        ...
        <Image src={closetPage} alt="high-key-app" priority />
        <Grid xs="minmax(auto, 432px)" m="5rem 0 3rem 0">
          <Text.H5 bold={false}>
