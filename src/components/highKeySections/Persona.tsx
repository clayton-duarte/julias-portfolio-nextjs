  ...
  return (
    <Grid container p="3rem" gap="3rem">
      ...
      <Grid m="3rem 0">
        ...
        <Text.H5 bold={false}>
          Jordan, a Canadian Gen Z, struggles with a closet full forgotten
          clothes, reflecting a broader issue of throwaway fashion culture.
          Despite a love for trendy and expressive outfits, he often feel
          overwhelmed by the abundance of choices.
        </Text.H5>
      </Grid>
      <Grid md="minmax(auto, 550px) auto" gap="0" align="justify">
        <GridBorderTop>
          <Image src={jordan} alt="high-key-app" priority />
        </GridBorderTop>
        <GridBorderTopLeft xsP="3rem 0" mdP="3rem" align="center">
          <Grid>
            ...
            <Grid.Ul size="1.5rem" gap="2rem">
              <li>
                <Text.H5 bold={false}>
                  Desires tools or methods to help plan outfits for the week
                  efficiently.
                </Text.H5>
              </li>
              <li>
                <Text.H5 bold={false}>
                  Values the experience and story behind clothing items, such as
                  a leather jacket from a thrift store in Amsterdam.
                </Text.H5>
              </li>
              <li>
                <Text.H5 bold={false}>
        ...
        <Grid align="center" p="1rem">
          <Grid>
            ...
            <Text.H5 bold={false} align="center">
              “I get so frustrated because I have clothes that I’m attached to,
              but I always forget about them and just remember when I
        ...
        <GridBorderLeft xsP="3rem 0" mdP="0 3rem">
          ...
          <Grid.Ul size="1.5rem" gap="2rem">
            <li>
              <Text.H5 bold={false}>
                Forgets about clothes after purchase, leading to
                underutilization.{' '}
              </Text.H5>
            </li>
            <li>
              <Text.H5 bold={false}>
                Feels restricted by the lack of choices in the closet during the
                winter season.{' '}
              </Text.H5>
            </li>
          </Grid.Ul>
