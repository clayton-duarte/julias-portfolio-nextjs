    ...
    >
      ...
      <Grid.Ul>
        <li>
          ...
          more likely to
          <strong>
            buy clothing every week
          </strong>
          {' '}
          than other generations (Oliver Wyman)
        </li>
        <li>
          <strong>
            75% of purchases
        ...
        <li>
          ...
          {' '}
          of Gen Z students interviewed say they 
          {' '}
          <strong>
            want to quit fast fashion
          </strong>
          {' '}
          and shop less.(ThredUp)
          {' '}
        </li>
        <li>
          A FirstInsight report reveals that 62% of Gen Z shoppers
          <strong>
            prefer to buy from sustainable brands
          </strong>
          , and a staggering 73% are
          <strong>
