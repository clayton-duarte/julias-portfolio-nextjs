    ...
    <>
      ...
      <SectionContainer>
        ...
        <Text.H4
          ...
          m="32px 0 82px 0"
        >
          After user interviews, I identified
          {' '}
          <Text.Strong
            color="RED"
          >
          ...
          , with one standing out: the struggle to declutter wardrobes. All five participants mentioned
          {' '}
          <Text.Strong
            color="RED"
          >
            feeling overwhelmed by their clothing
          </Text.Strong>
          , due to emotional attachment, lack of time to organize, or simply having too much. This shared challenge became the focus for the next steps in the design process.
        </Text.H4>
        <Grid
          align="stretch"
          gap="1.5rem"
