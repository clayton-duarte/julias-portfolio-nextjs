    ...
    <Grid bg='PRIMARY' color='WHITE' p='3rem 0'>
      <Grid container p='3rem' gap='3rem'>
        ...
        <Grid justify="center" gap='2rem'>
          <Text.H5 bold={false}>
            For now, the app does not have social features, but in the future, it will. So, considering ways a bad actor could misuse the app includes harassment, sending abusive messages to other users, and tracking user habits without consent.
          </Text.H5>
          <Text.H5 bold={false}>
            To prevent these dangerous behaviors, the app could implement robust reporting and moderation systems, ensure transparent privacy policies, and obtain user consent.
          </Text.H5>
        </Grid>
      </Grid>
    </Grid >
